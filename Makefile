...
_DEPS = $(YACCO).h sea_node.h sea_translator.h sea_internal.h sea_stack.h sea_debug.h sea_str.h sea.h
DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJS = $(YACCO).o $(FLEXO).o sea_node.o sea_translator.o sea_stack.o sea_str.o sea.o
